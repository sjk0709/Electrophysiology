...
class KernikCurrents():
    ...
    def i_f(self, v_m, E_K, E_Na, Xf, g_f):
        ...
        xF1 = self.x_F[0] # 5.79000000e-07
        xF2 = self.x_F[1] # -1.45897122e+01
        xF5 = self.x_F[2] # 2.00866502e+04
        xF6 = self.x_F[3] # 1.02023529e+01
        xF_const = self.x_F[4] # 2.39452914e+01
