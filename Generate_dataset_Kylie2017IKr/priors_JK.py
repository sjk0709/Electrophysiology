...
class BeattieLogPrior(pints.LogPrior):
    ...
    def __init__(self, transform, inv_transform):
        ...
        self.rmax = 1000 * 1e3   # Kylie : 1000 * 1e3  |  JK : 600.0
    ...
    def sample_without_inv_transform(self):
        p = np.zeros(9)

        # Sample forward rates
        p[1:3] = self._sample_partial2(self.vmax)
        p[5:7] = self._sample_partial2(self.vmax)

        # Sample backward rates
        p[3:5] = self._sample_partial2(-self.vmin)
        p[7:9] = self._sample_partial2(-self.vmin)
...
# a = BeattieLogPrior(None, None)
# a.check_min_max()
# print(a.rmax)
# print(a.rmin)
# print(a.sample_without_inv_transform())
