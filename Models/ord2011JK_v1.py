...
class IKr():
    ...
    def diff_eq(self, V, xf, xs, camk, nernst):
        ...
        IKr = self.GKr * np.sqrt(self.extra.Ko / 5.4) * x * r * (V - nernst.EK) # Rapid delayed Potassium current  in [uA/uF]
...
class IK1():
    ...
    def diff_eq(self, V, xk1, camk, nernst):
        ...
        IK1 = self.GK1 * np.sqrt(self.extra.Ko) * rk1 * xk1 * (V - nernst.EK)  # Inward rectifier Potassium current
